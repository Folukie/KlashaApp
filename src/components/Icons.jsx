export const DashboardIcon = () => (
  <svg
    ...
    fill="none"
  >
    <g clip-path="url(#clip0_4103_205)">
      <path
        d="M12 12V3"
        stroke="currentColor"
        stroke-width="2"
...
export const CheckoutIcon = () => (
  <svg
    ...
    fill="none"
  >
    <g clip-path="url(#clip0_4103_246)">
      <path
...
export const PaymentIcon = () => (
  <svg
    ...
    fill="none"
  >
    <g clip-path="url(#clip0_4103_253)">
      <path
          ...
          <g id="Button">
            ...
            <g id="Icon/None/chevron-left/S">
              <g id="i">
                <path
                  id="Vector"
                  d="M5.99921 10.9984L0.999207 5.99844L5.99921 0.998444"
                  stroke="currentColor"
                  stroke-width="2"
                  stroke-linecap="round"
                  stroke-linejoin="round"
